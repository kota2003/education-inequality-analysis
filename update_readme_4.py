...
- Findings section: "Available now" extended through Phase 07 with the
  ...
  subsection removed since the project is now closed at v1.0.
- Limitations and Future Work section replaced with its locked Phase 07
  ...
  epistemic stance + bulleted "Future Work" (synthetic control headline
  + IV / RD / DiD secondary) + bulleted "Structural Limitations" (4
  items: MNAR, Gini measurement heterogeneity, country-level
  aggregation, temporal extrapolation cost).
